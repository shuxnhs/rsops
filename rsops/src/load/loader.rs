...
use crate::module::bpf;
use crate::module::bpf::{Error, KProbe, Map, Module, Program, SocketFilter, UProbe, XDP};
use crate::module::cpus;
use crate::module::perf::PerfMap;
...
impl Loader {
    ...
    pub fn load(path: &str) -> Result<Loaded, LoaderError> {
        let mut module = bpf::parse(&path).map_err(LoaderError::ParseError)?;

...
#[doc = ""]
#[doc = "\t\t**BPF_PROG_TYPE_XDP**"]
#[doc = "\t\t\t*ctx_in* and *ctx_out* must be NULL."]
#[doc = ""]
...
pub const bpf_attach_type___MAX_BPF_ATTACH_TYPE: bpf_attach_type = 39;
...
pub const bpf_func_id___BPF_FUNC_MAX_ID: bpf_func_id = 166;
